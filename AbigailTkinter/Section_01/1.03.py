...
# path where the .py file and other file resources are saved
...
my_image = BitmapImage(file=f'{path}gir.xbm')
...
dance_photo = PhotoImage(file=f'{path}dance.gif')
...
# scale widget
Scale(my_frame_2, from_=0.0, to=100.0,
      label='Scale widget', orient=HORIZONTAL).pack()
...
file_object = open(f'{path}textcontent.txt')
...
my_canvas.create_text(130, 38, text='I am a Canvas Widget',
                      font=('arial', 8, 'bold'))
