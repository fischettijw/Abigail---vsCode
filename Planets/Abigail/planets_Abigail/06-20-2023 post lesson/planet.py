...
text_stats = Planet.FONT_LST_20.render(
    "Distance from the Sun", True, Planet.BLACK)  # FIX FONT SIZE
text_shortcuts = Planet.FONT_LST_20.render(
    "Keyboard Shortcuts", True, Planet.BLACK)  # FIX FONT SIZE
text_action_up = Planet.FONT_LST_16.render("Up Arrow   - FPS up 5", True, Planet.BLACK)
text_action_down = Planet.FONT_LST_16.render("Down Arrow - FPS down 5", True, Planet.BLACK)
...
while run == True:
    ...
    # BLIT Text Rectangle & Display (SHORTCUTS)
