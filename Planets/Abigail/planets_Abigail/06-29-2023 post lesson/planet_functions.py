...
def data(screen, clock, planets):
    ...
    while show_data:
        ...
        text_abigail = Planet.FONT_CS_36.render("by Abigail Lightle", True, Planet.WHITE)
...
def text_shortcuts(screen):
    ...
    screen.blit(planet_global_variables.text_last_shortcut, (40,570))
...
def rectabgle_law_of_gravity(screen):
